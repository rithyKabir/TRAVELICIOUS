...
<body>
	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation" ৳ 00 <div class="top-menu">
						...
						<div class="col-md-12">
							<div class="wrap-division">
								<div class="col-md-12 col-md-offset-0 heading2 animate-box">
									...
									<?php
									$hotelid1 = intval($_GET['hotelid']);


									$conn = new mysqli("localhost", "root", "", "tms");

									$sql = "select * from tblhotels where hotelid='$hotelid1'";
								...
								<div class="row">
									...
									$sql = "select * from tblhotelrooms where hotelid='$hotelid1'";
									$result = $conn->query($sql);
												...
												<div class="room-wrap">
													<div class="row">
														<div class="col-md-6 col-sm-6">
															<div class="room-img" style="background-image: url(admin/roomimages/<?php echo $row["roomimage"] ?>);"></div>
														</div>
														<div class="col-md-6 col-sm-6">
															<div class="desc">
																<h2><?php echo $row["roomname"] ?></h2>
																<p class="price"><span>৳<?php echo $row["roomprice"] ?></span> <small>/ night</small></p>
