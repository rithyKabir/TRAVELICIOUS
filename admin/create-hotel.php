...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO tblhotels(hotelname,hotellocation,hotelprice,hoteldetails,hotelimage) 
        VALUES(:hotelname,:hotellocation,:hotelprice,:hoteldetails,:hotelimage)";
		$query = $dbh->prepare($sql);
		
        $query->bindParam(':hotelname', $hotelname, PDO::PARAM_STR);
		$query->bindParam(':hotellocation', $hotellocation, PDO::PARAM_STR);
		$query->bindParam(':hotelprice', $hotelprice, PDO::PARAM_STR);
		$query->bindParam(':hoteldetails', $hoteldetails, PDO::PARAM_STR);
							...
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="hotelname" id="hotelname" placeholder=" Hotel name" required>
										</div>
									</div>
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Hotel Price in BDT</label>
										<div class="col-sm-8">
